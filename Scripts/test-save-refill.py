...
source=source.replace("root/'Native/build/libsm_native.so'","root/'refill-release/libsm_native.so'")
source=source.replace("out=root/'tracker-results'","out=root/'refill-release/SMTests'")
