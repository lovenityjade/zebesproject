...
SM_API void sm_dialogue_auto(float progress); /* timed presentation, no input or simulation writes */
...
/* Native pause-frame pieces, ROM palette and map-arrow cursor. */
